...
import { ResultObject } from '@/api/baseApiResponseModel/baseApiResponseModel';
import { ReportPostDetailRequestModel, ReportPostListRequestModel, ReportPostListResponseModel } from '@/api/features/report/model/ReportModel'; // Cập nhật đường dẫn
