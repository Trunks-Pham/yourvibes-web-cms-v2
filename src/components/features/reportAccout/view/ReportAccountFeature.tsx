...
"use client"
import { defaultReportRepo } from '@/api/features/report/ReportRepo'; // Cập nhật import
import CardFeature from '@/components/common/CardFeature';
import useColor from '@/global/hooks/useColor';
...
const ReportAccountFeature = () => {
  ...
  const {
    ...
    acceptReport,
    activateReport,
  } = ReportAccountViewModel(defaultReportRepo); // Sử dụng defaultReportRepo
      ...
      <>
        ...
        <Table
          columns={[
            ...
            {
              title: "Tài khoản bị báo cáo",
              dataIndex: ["reported_user", "email"], // Cập nhật truy cập email từ reported_user
              align: "center",
            },
            {
              title: "Trạng thái",
            ...
            {
              title: "Tài khoản báo cáo",
              dataIndex: ["user", "email"], // Cập nhật truy cập email từ user
              align: "center",
            },
            {
              title: "Admin",
              dataIndex: ["admin", "email"], // Cập nhật truy cập email từ admin
              align: "center",
            },
            {
              title: "Thời gian",
